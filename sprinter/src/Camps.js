        ...
        <div style = {{backgroundColor: "#E8E5DD", fontFamily: "Cambria"}}>
           <Container><br></br>
                <Row>                  
                    ...
                    <Col>
                <Image height= {350} width = {500} src="https://cdn.pixabay.com/photo/2017/08/18/17/18/sailing-2655756_1280.jpg" rounded />
                    </Col>
                </Row><br></br>
            </Container>
        </div>
            <Container style = {{fontFamily: "Cambria"}}><br></br>
                <Row>
                    <Col>
                    <Image height= {330} width= {500} src="https://cdn.pixabay.com/photo/2015/12/09/11/43/friends-1084598_1280.jpg" rounded />
                    </Col>
                    <Col>
                        <h2 style = {{fontFamily: "Cambria", color: "#94790D"}}>
                            World class beaches
